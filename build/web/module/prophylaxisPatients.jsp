...
<openmrs:htmlInclude
	...
	<openmrs:htmlInclude
		...
		<openmrs:htmlInclude
		file="/moduleResources/drugorderexport/testCss.css" />
...
<i style="color: red"><spring:message code="drugorderexport.onlyProphylaxisMsg" /></i>

<br/><br/>

<b class="boxHeader" style="width: 100%"><spring:message code="drugorderexport.onlyProphyPatients" /></b>

<div>
<div
	style="background: #E2E4FF; border: 1px #808080 solid; padding: 0.5em; margin-bottom: 0em">
<div>
<form action="patientsOnProphylaxis.form" method="post" name=""
...
<c:if test="${fn:length(objectsList)>0}">
	...
	<table>
	<tr>
	<td><form action="patientsOnProphylaxis.form?export=excel" method="post">
	...
	<td><form action="patientsOnProphylaxis.form?export=pdf" method="post">
