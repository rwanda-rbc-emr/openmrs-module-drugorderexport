...
<b class="boxHeader" style="width: 100%"><spring:message code="drugorderexport.changedRegimen" /></b>

<div>
<div
	style="background: #E2E4FF; border: 1px #808080 solid; padding: 0.5em; margin-bottom: 0em">
<div>
<form action="patientWhoHaveChangedRegimen.form" method="post" name=" "
...
<c:if test="${fn:length(objectsList)>0}">
   ...
   <div style="border: 1px #808080 solid; padding: 0em; margin: 0em;width:500"><!--(Start) This is repeated depending on the number of regimen of the patient -->
	...
	<spring:message code="drugorderexport.changed" />
	...
	<table><tr>
	<td>
	<form action="patientWhoHaveChangedRegimen.form?export=excel" method="post">	
	...
	<form action="patientWhoHaveChangedRegimen.form?export=pdf" method="post">
	<input type="hidden" name="startdate" value="${param.startdate}"/> 
	<input type="hidden" name="enddate" value="${param.enddate}" /> 
	<input type="hidden" name="anyOrAll" value="${param.anyOrAll}" />
	<input type="hidden" name="gender" value="${param.gender}" />
	...
	<thead>
		<tr style="color: #666; font-weight: bold;">
			...
			<th><spring:message code="drugorderexport.startSecondLine" /></th>
